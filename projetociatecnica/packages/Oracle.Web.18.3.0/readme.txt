Oracle.Web Nuget Package Version 18.3.0 README
==============================================
...
1. Un-GAC and un-configure any existing Oracle ASP.NET providers 18.3 versions you have installed. 
...
reate both x64 and x86 folders with the necessary assemblies added to them.
...
<configuration>
  <system.web>
    ...
    <sessionState mode="Custom" customProvider="OracleSessionStateStore">
      <providers>
        <clear />
        <add name="OracleSessionStateStore" type="Oracle.Web.SessionState.OracleSessionStateStore, Oracle.Web, Version=4.122.18.3, Culture=neutral,PublicKeyToken=89b483f429c47342" connectionStringName="OraAspNetConString" />
      </providers>
    </sessionState>
  </system.web>
</configuration>
